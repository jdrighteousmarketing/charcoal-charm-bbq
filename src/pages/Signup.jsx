...
const { data: authData, error: authError } =
  await supabase.auth.signUp({
    ...
    options: {
      ...
      /*
       * With email confirmation enabled, Supabase may intentionally return an
       * obfuscated user instead of an obvious duplicate-account error.
       * That response commonly has an empty identities array.
       */
    ...
    >
      ...
      <form onSubmit={handleRegister} className="space-y-4">
        ...
        <p className="pt-1 text-center text-xs text-muted-foreground">
          Account access is powered by JD Righteous LLC
        </p>
      </form>
    </AuthLayout>
  );
